...
def display_condition(condition_tag: str, time_of_day: str) -> str:
    '''
    Returns a user-facing condition label that stays realistic with time context.

    Examples:
      Sunny + Late Night -> Clear Night
      Sunny + Night      -> Clear Night
      Cloudy + Night     -> Cloudy
    '''
    if condition_tag == 'Sunny' and time_of_day in {'Night', 'Late Night'}:
        return 'Clear Night'
